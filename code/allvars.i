# 1 "./code/allvars.h"
# 1 "/mnt/lustre/scratch/cs390/nIFTy/62.5_dm_II/SussexBigRun2013/L-Galaxies_development//"
# 1 "<command-line>"
# 1 "./code/allvars.h"
...
# 9 "./code/allvars.h" 2
# 107 "./code/allvars.h"
extern double SFH_t[62][20][20];
extern double SFH_dt[62][20][20];
extern int SFH_Nbins[62][20][20];
extern int SFH_ibin[62][20];
# 339 "./code/allvars.h"
#pragma pack(1)
...
struct GALAXY
{
  ...
  float BlackHoleGas;
  double H2fraction;
  double H2fractionr[12];
# 713 "./code/allvars.h"
  double MetalsColdGas;
  double MetalsColdGasr[12];
  double MetalsBulgeMass;
  double MetalsDiskMass;
  double MetalsDiskMassr[12];
  float MetalsHotGas;
  float MetalsEjectedMass;
# 729 "./code/allvars.h"
  float PrimordialAccretionRate;
  ...
  float YLum[6][62];
  float LumBulge[6][62];
  float YLumBulge[6][62];
  float LumDust[6][62];
# 811 "./code/allvars.h"
  float MassWeightAge[62];
...
extern int TotHalos;
extern int TotGalaxies[62];
extern int *TreeNgals[62];
...
extern int ListOutputSnaps[62];
extern float ListOutputRedshifts[62];

extern double ZZ[62];
extern double AA[62];

extern double AA_OriginalCosm[62];

extern double Age[62];
...
extern float RedshiftTab[62];
extern float LumTables[6][4][62][220];
extern float FilterLambda[6];



extern int NLambdaFilter[6];
# 1190 "./code/allvars.h"
extern long mu_seed;
...
extern FILE *FdGalDumps[62];





extern double h2frac[101][13];
